...
<head>
  <meta charset="UTF-8">
  <title>Glassmorphic Modern Responsive Landing page by shobhitdev</title>
...
<nav>
  <a href="./index.html" class="sitename"><b>Question & Answer</b></a>
  <a href="./inicio.html" class="menu">Inicio</a>
  <a href="./somos.html" class="menu">Quienes Somos</a>
  <a href="" class="menu">Iniciar sesion</a>
...
<br>
<div> 
  <h1>QUIENES SOMOS :D</h1> 
  <p>Somos estudiantes que estamos haciendo un proyecto que se trata sobre preguntas y respuestas, que se llama question and aswerd nuestro proyecto se trata de ayudarles a los docentes hacer un trabajo mas didactico, para que los estudiantes que motiven en aprender mas y no se aburran a la hora de hacer exsamenes o actividades. <p>
    <br>
    <div class="cajas">
      <!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Cambiar Tipografía</title>

</head>
<body>
    <div class="jafet">
      <h1> Jafet</h1>
      <img src="imagen/jafe.jpg" alt="">
      <p><small>Jafet es un chico de 16 años que se encargo de diseñar la pagina web</small> </p>
    </div>
    <div class="carlos">
      <h1> Carlos </h1>
      <img src="imagen/Carlos.jpg" alt="">
      <p><small>Carlos es un chico de 17 años que se encargo de hacer el scrum master de la pagina</small></p>
    </div>
      
    <div class="isabella">
    <h1>Isabella </h1>
    <img src="imagen/isabela.jpg" alt="">
    <p><small>Isabella es una chica de 16 años que tambien se encargo en diseñar la pagina</small> </p>
  </div>

    <div class="fred">
      <h1>Fred </h1>
      <img src="imagen/Fred.jpg" alt="">
<p><small>Fred es un chico de 16 años que es el programador principal de la pagina web</small>
    </body>
</html>
