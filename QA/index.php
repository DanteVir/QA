...
<nav>
  <img class="sitename" src="./imagen/image.png" alt="" style="width: 100px;">
  <p class="menu"><a href="./login/registro.php">Registro</a></p>
  <p class="menu"><a href="./login/Login.php">Inicio de sesion</a></p>
  <p class="menu"><a href="">Crear Cuestionario</a></p>
  <p class="menu"><a href="logout.php">Cerrar sesion</a></p>
...
<a href="nosotros.php" target="_blank" class="button first"><button>Sobre nosotros</button><span></span></a>
<a href="sjjs" target="_blank" class="button first" style="margin-top:550px;"><button>Crea tu cuestionario</button><span></span></a>
...
<?php else: ?>
      ...
      <a href="./login/registro.php">SignUp</a>
    <?php endif; ?>
